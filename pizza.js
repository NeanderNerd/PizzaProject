...
function getVeggy(runningTotal, text1, text2) {
   ...
   document.getElementsByClassName("orderpopup").style.opacity=1;
   document.getElementsByClassName("text1").innerHTML=text1;
   document.getElementsByClassName("text2").innerHTML="<p>"text2"</p>";
   document.getElementsByClassName("runningtotal").innerHTML="<h3>Total: <strong>$"+runningTotal+".00"+"</strong></h3>";
}